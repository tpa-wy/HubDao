  ...
  <div class="yield-farming">
    ...
    <div class="outer">
      <div class="Rectangle">
        <div class="left">
          <svg
            ...
            class="icon-block icon-block-1"
            :class="{ 'icon-checked': is_show }"
          >
            <path
      ...
      <div class="block" v-show="is_show">
        <div
          class="block-item block-1"
          v-for="item in list"
          :key="item.list2"
          :class="{ 'block-item-height': !item.checked }"
        >
          <div class="content">
            <div class="title">
