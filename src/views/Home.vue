              ...
              >
                ...
                <g id="레이어_2" data-name="레이어 2">
                  <g id="레이어_1-2" data-name="레이어 1">
                    <path
                      class="cls-1"
                      d="M137,71H124.8V43.52H103.71V71H91.42V5.2h12.29V32.55H124.8V5.2H137Z"
                    />
                    <path
                      class="cls-1"
...
export default {
  ...
  computed: {
    account() {
      return this.$store.state.account || "Connect";
    },
  },
  methods: {
    ...
    menuselect(index) {
      console.log(index);
      if (index == "/ExchangeHUB/Swap" || index == "/ExchangeHUB/Liquidity") {
...
.cls-2 {
  opacity: 0;
  fill: url(#무제_그라디언트_14);
}
.cls-3 {
  fill: url(#무제_그라디언트_14-2);
}
.cls-4 {
  fill: url(#무제_그라디언트_14-3);
}
.cls-5 {
  fill: url(#무제_그라디언트_14-4);
}
.cls-6 {
